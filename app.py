...
class UltraStateApp:
    ...
    def _build_terrain_graph(self, detail_data, metric='Cadence', use_miles=True):
        """
        ...
        if metric == 'Cadence':
            ...
            return self._build_terrain_graph(detail_data, metric='Cadence', use_miles=use_miles)
        ...
        # Secondary Y-axis (Elevation – always the same)
        fig.update_yaxes(
